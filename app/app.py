...
p5 = "small girl,little girl,young girl,"
p6 = "(child face:1.2),"
...
p9 = "bodysuit,leotard,bodystocking,skin_tight,(see-through:1.4),"
p10 = "black_bodysuit,black_leotard,"
p11 = "(covered_nipples),(covered_erect_nipples),"
p12 = "covered_navel,"
p13 = "cleft_of_venus,cameltoe,clitoris,covered_clitoris,very pubic hair,very pussy hair,"
p14 = "Petite,Short body,Thin,Bony,Slim,Slender,Narrow waist,Ribs,skinny,"
p15 = "nsfw,"
p16 = "armor, armor dress, wings, Valkyrie, warrior, knight, priestess, breast focus, (Sleeping on one's side:1.5), sleeping in a side-lying position,"
# 正面
global_prompt = f"{p3}{p4}{p5}{p6}{p7}{p8}{p9}{p10}{p11}{p12}{p13}{p14}{p15}{p16}"
# 负面
